    ...
    <div className="min-h-screen bg-transparent py-20 px-6">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-4 tracking-tight">
          Complete Your <span className="text-gradient-colorful">Payment</span>
        </h1>
        <p className="text-lg text-zinc-300 max-w-2xl mx-auto">
          Thank you for your application, <span className="text-orbit-pink font-bold">{applicantData.fullName}</span>! 
      ...
      <div className="mt-12 text-center text-zinc-500 text-sm">
        ...
        <p className="mt-2 text-orbit-pink font-bold">Secure Payment Gateway • 256-bit Encryption</p>
      </div>
    </div>
  );
}
