...
export default function TermsAndConditions() {
  return (
    <section className="py-24 bg-transparent border-t border-white/5 min-h-screen">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4">Terms and <span className="text-gradient-colorful">Conditions</span></h2>
          <p className="text-zinc-400">Please read these terms carefully before joining OrbitX MCN.</p>
        </motion.div>
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="glass-colorful p-8 md:p-12 rounded-3xl border border-white/10 shadow-sm text-left"
        >
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-display font-bold mb-3 text-white">1. Introduction</h3>
            ...
            <div>
              <h3 className="text-xl font-display font-bold mb-3 text-white">2. Services Provided</h3>
              <p className="text-zinc-300 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-display font-bold mb-3 text-white">3. Revenue Share</h3>
              <p className="text-zinc-300 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-display font-bold mb-3 text-white">4. Content Guidelines</h3>
              <p className="text-zinc-300 leading-relaxed">
            ...
            <div>
              <h3 className="text-xl font-display font-bold mb-3 text-white">5. Termination</h3>
              <p className="text-zinc-300 leading-relaxed">
